...
public class BackendCopy {
   ...
   * 
   * String user = "jasalina"; String passwd = "";
   * 
   ...
   * 
   * 
   * // System.out.println("Make sure we are here!"); // checkBeds(conn ,"5001");
   * // assignPatientToBed(conn, "3001", "5001"); // assignPatientToBed(conn,
   * "3001", "5001"); // releaseBed(conn, "5001"); // // createCheckIn( conn,
   * "3001", "111", "5001", "2019-09-03", "1003", "XXX", "20"); //
   * transferPatient( conn, "5", "3002", "222", "5001", "2019-09-03",
   * "2019-09-19", "1003", "XXX", "20"); // enterMedicalRecords(conn, "2003", "6",
   * "baa", "critical", "toolate", "Donttest", "TheEnd", "1000", "50000", "6000");
   * // updateMedicalRecords(conn, "2003", "6", "baa", "StillAlive", "Hope",
   * "Try", "Chance", "99", "555", "300");
   * 
   * } finally { close(rs); close(stmt); close(conn); } } catch(Throwable oops) {
