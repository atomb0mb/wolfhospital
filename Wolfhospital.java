  ...
  public static void main(String[] args) {
    try {
      ...
      try {
        ...
        //
        // createCheckIn( conn, "3001", "111", "5001", "2019-09-03", "1003", "XXX",
        // "20");
        // transferPatient( conn, "5", "3002", "222", "5001", "2019-09-03",
        // "2019-09-19", "1003", "XXX", "20");
        // enterMedicalRecords(conn, "2003", "6", "baa", "critical", "toolate",
        // "Donttest", "TheEnd", "1000", "50000", "6000");
        // updateMedicalRecords(conn, "2003", "6", "baa", "StillAlive", "Hope", "Try",
        // "Chance", "99", "555", "300");
...
=======
    ...
    public static void main ( String[] args ) {
        try {
            ...
            try {
                ...
                // releaseBed(conn, "5001");
                //
                // createCheckIn( conn, "3001", "111", "5001", "2019-09-03",
                // "1003", "XXX", "20");
                // transferPatient( conn, "5", "3002", "222", "5001",
    ...
    static void enterPatient(Statement stmt, String pId, String ssn, String pName, String dob, String gender, String patientAge, String patientPhone, String patientAddress, String status) {
        try {
            ResultSet rs = null;
...
=======
    static void enterStaff ( Statement stmt, String staffID, String hID, String staffName, String homeAddress, String officeAddress,
...
<<<<<<< HEAD
  // #1 (Abhi)
  static void enterHospital(String hId, String aId, String hAddress, String hPhone, String s1, String s1cost, String s2,
      String s2cost, String capacity) {

  }

  static void updateHospital(String hId, String aId, String hAddress, String hPhone, String s1, String s1cost,
...
<<<<<<< HEAD
  ...
  static void enterPatient(String pId, String ssn, String pName, String dob, String gender, String patientAge,
      String patientPhone, String patientAddress, String status) {

  }

  static void updatePatient(String pId, String ssn, String pName, String dob, String gender, String age,
      String patientPhone, String patientAddress, String status) {
  ...
  static void enterStaff(String staffID, String hID, String staffName, String homeAddress, String officeAddress,
      String sgender, String age, String jobTitle, String department, String specPosition, String staffPhone,
      String email) {

  }

  static void updateStaff(String staffID, String hID, String staffName, String homeAddress, String officeAddress,
      String sgender, String age, String jobTitle, String department, String specPosition, String staffPhone,
      String email) {
   ...
   * @param registrationFee  is the fee of registration
   **/
  static void transferPatient(Statement stmt, String cID, String pID, String hID, String bID, String startDate,
    ...
    try {
      ...
      try {
        ...
        // Create new CheckIn
        // Note: The startdate for new checkIns records is endDate of previous checkIns
        // records
        String sqlInsert = "insert into CheckIn(pID, hID, bID, startDate, respDoctor, currentDiagnosis, registrationFee) VALUES (";
        sqlInsert += pID + ", ";
        sqlInsert += hID + ", ";
        ...
        System.out.println(
            "Successfully transferred patient " + pID + " from Hospital " + prevHopital + " to Hospital " + hID);
...
=======
     ...
     * 
     * @param stmt
     *            the statement from the db connection
     **/
     ...
     *            the statement from the db connection
     * @param hID
     *            is the hospital id that selected
     * @param spec
     *            is the specialty of the selected
     **/
     ...
     *            is the number of bed number
     * @param startDate
     *            is the start date of check in to the hospital
     * @param respDoctor
     *            is the reponsible Doctor
     * @param currentDiagnosis
     *            is the current diagnosis information
     * @param registrationFee
     *            is the fee of registration
     **/
    static void createCheckIn ( Statement stmt, String pID, String hID, String bID, String startDate, String respDoctor,
            String currentDiagnosis, String registrationFee ) {
        try {
    ...
    /**
     * This function update the checkin/out which is checking out the patient
     * from the hospital
     * 
     * @param stmt
     *            the statement from the db connection
     ...
     *            is check in/out id
     * @param endDate
     *            is date of checking out or discharge to the hospital
     **/
...
=======
     ...
     *            is patient id
     * @param hID
     *            is the hospital to be transferred
     * @param bID
     *            is the number of bed number
     * @param endDate
     *            is date of checking out or discharge to the hospital
...
<<<<<<< HEAD
  ...
  static void createInitialTables(Statement stmt) {
    try {
      ...
      // Check-in #when creating check in ensure that patient is assigned to a bed by
  ...
  static void populateDemoTables(Statement stmt) {
    ...
    try {
      ...
      // Beds #1
      stmt.executeUpdate(
          "insert into Beds(bID, hID, spec, staffID, reserved) VALUES (5001, 111, 'neurology', 1002, 0)");
      ...
      // Possibly revise for startDate and endDate for MedicalRecords instead of
      // creating new checkins
...
=======
     ...
     *            is checkIns id
     * @param prescriptions
     *            is prescriptions info
     * @param diagnosisDetails
     *            is diagnosis details
     * @param treatment
     *            is treatment info
     * @param test
     *            is the test info
     ...
     *            is the fee of consultion
     * @param testfee
     *            is the fee of test
     * @param treatmentfee
     *            is the fee of treatment
     **/
     ...
     *            is the fee of treatment
     **/
    static void updateMedicalRecords ( Statement stmt, String mID, String cID, String prescriptions,
            String diagnosisDetails, String treatment, String test, String result, String consultationfee,
            String testfee, String treatmentfee ) {
        try {
    ...
    /**
     * This function create billing account for the patient. It will prompt user
     * to enter hospital id so that it validates if the hospital has open beds
     * for the patient. If the bed is available, it will create a billing
     ...
     *            is the hospital id that selected
     * @param pID
     *            is patient to be admit to the hospital
     * @param payerSSN
     *            is prescriptions info
     * @param billingAddress
     *            is the billing address of the patient
     * @param paymentInfo
     *            is the payment info for the patient
     * @param medicationPrescribed
     *            is the fee of test
     * @param test
     *            is the test of the patient
     * @param result
     *            is the result of the patient
     * @param registrationfee
     *            is the registration fee
     * @param accommodationfee
     *            is the fee of accommodation
     * @param visitDate
     *            is the date of visit of the patient
     **/
     ...
     * 
     * @param stmt
     *            is the statement object used to execute MariaDB statements.
     */
    static void createInitialTables ( Statement stmt ) {
        try {
    ...
    /**
     * This is the function that populates the data values for all of the
     * tables.
     * 
     * @param stmt
     *            is the Statement object used to execute MariaDB statements
